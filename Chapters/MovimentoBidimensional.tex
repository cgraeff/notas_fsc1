...
%%%
    ...
    \path[name path=trajetoria] (0,2) .. controls (1,0.3) and (2,2.2) .. (3,1.5);
       
    \path[draw, densely dotted, ->, name intersections={of=trajetoria and verta}](0,0) --  (intersection-1) coordinate (intersec1);
    \path[draw, densely dotted, ->, shorten >=1pt, name intersections={of=trajetoria and vertb}](0,0) -- (intersection-1) coordinate (intersec2);
    ...
    \path[draw, densely dotted, ->, name intersections={of=trajetoria and vertc}](0,0) --  (intersection-1) coordinate (intersec3);
    \path[draw, densely dotted, ->, shorten >=1pt, name intersections={of=trajetoria and vertd}](0,0) -- (intersection-1) coordinate (intersec4);
...
\end{tikzpicture}
\caption{Todo movimento pode ser considerado como uma série de deslocamentos retilíneos infinitamente pequenos. Na figura, cada vetor é retilíneo, porém como são pequenos, temos uma boa aproximação para uma curva.\label{Fig:TrajetoriaComoSucessaoDeDescolamentosInfinitesimais}}
\end{marginfigure}
...
\begin{tikzpicture}[>=Stealth, scale = 0.75]
	...
	\draw[arrows={-Stealth[harpoon]}] (0,0) -- node[above, sloped]{$\vec{v}_f$} (at);
