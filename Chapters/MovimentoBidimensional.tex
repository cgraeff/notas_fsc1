...
%%%
    ...
    \draw [dashed, thin, use tangent] (-1.5,0) -- (1.5,0);
    \draw [->, thick, use tangent] (0,0) -- node[below]{$a_t$}(0.5,0);
    \draw [->, thick, use tangent] (0,0) -- node[above right]{$a_c$}(0,0.5);
    ...
    \draw[use tangent, fill] (0,0.75) node[right]{$C$} circle (0.5pt);
