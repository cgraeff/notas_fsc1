...
Nas próximas seções, utilizaremos o conteúdo do capítulo anterior para definir as variáveis cinemáticas em termos de vetores. Após isso, analisaremos alguns movimentos bidimensionais específicos.
