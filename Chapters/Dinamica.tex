...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Equilíbrio de forças}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tikzpicture}[>=Stealth, scale = 1.2,
    ...
    \draw[->, thick] (fix) -- +(60:0.866) node[below right]{$\vec{N}$};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Equilíbrio de um sistema que envolve um nó}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Explicar que temos que aplicar a segunda lei para o nó, que esse tipo de exercício é comum, que o nó pode ser um treco qualquer ao qual as cordas estão presas, como um anelzinho.
...
Através das equações para o eixo vertical, podemos concluir que
\begin{align}
    N_t &= N_1 + N_2 \\
    &= P_1 + P_2 + P_3\\
    &= m_1g + m_2g + m_3g\\
