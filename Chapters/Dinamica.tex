...
\end{tikzpicture}
\caption{Neste sistema, os blocos têm acelerações em eixos diferentes, porém -- como eles estão ligados por um fio inextensível --, temos que $a_{1,x} = -a_{2,y}$.\label{Fig:MaquinaAtwoodHoriz}}
\end{marginfigure}
