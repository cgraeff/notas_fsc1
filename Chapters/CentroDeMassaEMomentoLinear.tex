...
%\textbf{Tem uma discussão muito interessante no Landau - Mechanics que permite definir o conceito de centro de massa a partir do momento linear, pensando através de referenciais. Depois que tivermos uma boa discussão de referenciais, elaborar uma explicação alternativa a essa que temos aqui, para enriquecer o texto.}
