...
\textbf{Não tá boa essa passagem onde introduzimos o centro de massa. Não está claro por que fazemos isso depois da Eq. \eqref{Eq:SegundaLeiSistemaDeParticulas}. Pra obter a Eq. \eqref{Eq:SegundaLeiSistemaDeParticulasMConst}, podemos considerar que a velocidade é a mesma (como em um corpo rígido), mas isso não leva a uma velocidade do CM. Além disso, tem o problema de não cobrir o caso de não termos um corpo rígido.}
