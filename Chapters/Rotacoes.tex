...
\begin{align}
    \tau_{\text{Res}} &= I \alpha \\
    F d_f \sen\phi + P_1 d_1 \sen\phi - P_2 d_2 \sen\varphi - P_c d_c \sen\varphi &= I\alpha.
\end{align}
%
...
\textbf{Rever o texto, falar que é uma aplicação do conceito de alavanca}
...
\textbf{o texto abaixo fica aqui mesmo.}
...
\textbf{emendar com o texto abaixo}
...
\textbf{Aqui temos que comentar como a solução é de fato feita: aplicando a segunda lei pra translação/rotação pra cada corpo e fazendo um sistema de equações e resolvendo (aqui é que entra a máquina de atwood)}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Discussão: Máquina de Atwood}
%\label{Par:AcelMaqAtwood}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{Se mudar isso pra adiante, dá pra usar o momento de inércia direto (tenho que dizer que vai ser visto adiante e dar a expressão)}
