...
%Um sistema pode ser definido como um conjunto de partículas que interagem através de uma ou mais forças. Ao definirmos um sistema, automaticamente definimos uma \emph{fronteira} do sistema, que o separa do resto do universo.

%A utilidade de se definir um sistema reside no fato de que em muitos casos, podemos definir um sistema de maneira que nenhum trabalho externo é realizado sobre qualquer partícula do sistema. Isso nos permite dizer que a energia cinética total do sistema --~isto é, a soma das energia cinéticas das partículas que compõe o sistema~-- é constante. Devido às forças entre as partículas, pode ocorrer a transferência de energia cinética entre as partículas, porém a energia cinética do sistema como um todo se mantém constante. Esse tipo de sistema é denominado um \emph{sistema fechado}. Mesmo em casos onde o sistema não é fechado, se soubermos qual é o trabalho total realizado sobre o sistema, podemos saber qual é a energia cinética total, pois
