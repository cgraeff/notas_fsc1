...
\textbf{lançamento para cima, calcular a velocidade inicial se após $t$ segundos o corpo está na posição $y$ (va volta)}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Exemplo:?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\textbf{alguma coisa que use e eq da posição com velocidade final (carro chega na linha de chegada com velocidade tal, após certo tempo acelerando, qual é a aceleração?)} 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Exemplo: ?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\textbf{Alguma coisa com torricelli (algo na linha de frenagem de um carro, velocidade mínima para passar uma distância, velocidade máxima para conseguir parar)}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Exemplo: ?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\textbf{qq coisa que permita usar a fórmula $\Delta x = (v_0 + v)t/2$} 
