...
\end{equation}
%
A velocidade instantânea é o valor de velocidade no momento considerado. É o que é mostrado pelo velocímetro de um carro, por exemplo\footnote{Isso é verdade somente para caros em que o sistema de medidas é analógico. Para medidas digitais, o valor é uma média de uma série de medidas tomadas em um curto intervalo de tempo}.
