...
De maneira análoga ao caso da evolução temporal da posição, podemos dizer que para cada instante de tempo $t_i$ temos uma velocidade $v_i$ associada. Assim, podemos denotar o conjunto de instantes de tempo $t$ e o conjunto de posições $x$ correspondentes a tais instantes como uma função:
